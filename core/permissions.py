...
ADMIN_MODULES = [
    ...
    AdminModule("equipment", "Equipment", "/admin/equipment", "wrench", ("/admin/equipment", "/equipment")),
    AdminModule("equipment_requests", "Equipment in Use", "/admin/request-equipment", "clipboard-list", ("/admin/request-equipment", "/equipment/request-equipment", "/patient/assign-equipment")),
