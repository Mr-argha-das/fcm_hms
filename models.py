...
class SiteSettings(Document):
    company_name = StringField(default="sridevimatka")
    ...
    logo_path = StringField(default="/media/settings/sridevimatka_logo.png")
    ...
    account_holder_name = StringField(default="sridevimatka")
